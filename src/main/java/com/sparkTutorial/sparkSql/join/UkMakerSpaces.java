...
public class UkMakerSpaces {
	...
	public static void main(String[] args) throws Exception {
		...
		Dataset<Row> postCode = session.read().option("header", "true").csv("in/uk-postcode.csv").withColumn("PostCode",
		...
		Dataset<Row> joined = makerSpace.join(postCode, makerSpace.col("Postcode").startsWith(postCode.col("Postcode")),
				"left_outer");
