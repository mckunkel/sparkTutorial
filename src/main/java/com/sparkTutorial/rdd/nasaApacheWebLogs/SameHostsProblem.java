...
public class SameHostsProblem {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * "in/nasa_19950701.tsv" file contains 10000 log lines from one of
		 * NASA's apache server for July 1st, 1995. "in/nasa_19950801.tsv" file
		 * contains 10000 log lines for August 1st, 1995 Create a Spark program
		 * to generate a new RDD which contains the hosts which are accessed on
		 * BOTH days. Save the resulting RDD to "out/nasa_logs_same_hosts.csv"
		 * file.
		 * 
		 * Example output: vagrant.vf.mmc.com www-a1.proxy.aol.com .....
		 * 
		 * Keep in mind, that the original log files contains the following
		...
		JavaRDD<String> augustHosts = augustFirstLogs.map(line -> line.split("\t")[0]);

		JavaRDD<String> intersection = julyHosts.intersection(augustHosts);
