...
public class SumOfNumbersProblem {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * 
		 * Each row of the input file contains 10 prime numbers separated by
		 * spaces.
		 */
		...
		JavaRDD<String> primeNumbers = sc.textFile("in/prime_nums.text");
		JavaRDD<String> numbers = primeNumbers.flatMap(line -> Arrays.asList(line.split("\\s+")).iterator());
